...
final class SecondOnboardingViewController: UIViewController, OnboardingViewProtocol {
    // MARK: Presenter
    ...
    override func viewDidLoad() {
        ...
        presenter = SecondOnboardingPresenter()
    ...
    @objc private func pushViewController() {
        self.navigationController?.pushViewController(ThirdOnboardingViewController(), animated: true)
    }
}
